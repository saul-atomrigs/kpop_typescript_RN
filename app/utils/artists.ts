...
export const artistMetaData = {
  aespa: {
    ...
    fandom: 'MY (마이)',
    albums: ['Black Mamba', 'forever', 'Next Level', 'Savage', 'Dreams Come True'],
  ...
  Apink: {
    debut: '2011.04.19',
    members: ['Park Cho Rong,', 'Yoon Bo mi,', 'Jeong Eun Ji,', 'Kim Nam ju,', 'Oh Ha Young,'],
  ...
  ASTRO: {
    debut: '2016.02.23',
    members: ['MJ', 'Jin Jin', 'Cha Eun Woo', 'Moon Bin', 'ROCKY', 'Yoon Sanha'],
    leader: 'Jin Jin',
    label: 'fantagio',
    fandom: 'AROHA',
    albums: [],
  ...
  ATEEZ: {
    debut: '2018.10.24',
    members: ['Seong Wha', 'Hong Joong', 'Yoon Ho', 'Yeosang', 'San', 'Min Gi', 'Woo Young', 'Jong Ho'],
    leader: 'Hong Joong',
  ...
  Kep1er: {
    debut: '2021.10.22',
    members: ['Yujin', 'Xiaoting', 'Mashiro', 'Chaehyun', 'Dayeon', 'Hikaru', 'Huening Bahiyyih', 'Youngeun', 'Yeseo'],
    leader: 'Yujin',
  ...
  'NCT 127': {
    debut: '2016.07.07',
    members: ['Taeil', 'Johnny', 'Taeyong', 'Yuta', 'Doyoung', 'Jaehyun', 'Winwin', 'Jeongwoo', 'Mark', 'Haechan'],
    leader: 'Taeyong',
    label: 'SM Entertainment',
    fandom: 'NCTzen',
    albums: [],
  ...
  'Stray Kids': {
    debut: '2018.03.25',
    members: ['Bang Chan', 'Leeknow', 'Changbin', 'Hyunjin', 'Han', 'Felix', 'Seungmin', 'I.N'],
    leader: 'Bang Chan',
    label: 'JYP Entertainment',
    fandom: 'STAY',
    albums: [],
  ...
  Twice: {
    debut: '2015.10.20',
    members: ['Nayeon', 'Momo', 'Jihyo', 'Sana', 'Jeongyeon', 'Chaeyoung', 'Tzuyu', 'Dahyun', 'Mina'],
    leader: 'Nayeon',
    label: 'JYP Entertainment',
    fandom: 'Once',
    albums: [],
  ...
  NewJeans: {
    ...
    fandom: '',
    albums: [],
    twitterIDurl: 'NewJeans_ADOR',
    twitterID: '1476476838180696073',
  },
